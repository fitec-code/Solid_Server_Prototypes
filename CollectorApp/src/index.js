import {
  ...
  const buttonReadHeating = document.getElementById("btnReadHeating")
  ...
  async function readHeating(dat) {
    let list = ['http://localhost:3000/User1']
    for (let i = 0; i<list.length; i++) {
        let POD = list[i]
        let HeatingUrl = POD + '/' + dat
        ...
        let avg = tot / items.length
        console.log(dat + ' Average: ' + avg)
        console.log(dat + ' Min: ' + min)
        console.log(dat + ' Max: ' + max)
    }
  }
